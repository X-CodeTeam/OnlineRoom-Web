<template>
  <el-dialog
    ...
    width="900px"
    class="ly-waring_-dialog dialog-center"
    @close="close"
  >
    <el-form ref="form" :model="form" label-width="160px">
      <div v-if="warningType == 1">
        ...
        <el-row>
          <el-form-item label="处理时间：">{{ form.handleTime }} </el-form-item>
        </el-row>
  ...
  methods: {
    showEdit(row) {
      if (row) {
        ...
        this.fetchData(result.warningId);
      }
